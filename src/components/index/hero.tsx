                ...
                <div className='flex justify-between w-full'>
                    <div className='flex flex-col gap-y-1 px-8 w-full xl:py-0 lg:py-32 md:py-40 sm:py-48 min-[425px]:py-56 py-60'>
                        ...
                        <motion.p initial={{ transform: 'translateX(-20px)', opacity: 0 }} whileInView={{ transform: 'translateX(0)', opacity: 100 }} transition={{ duration: 1, delay: 0.1, ease: [0.39, 0.21, 0.12, 0.96], }} viewport={{ amount: 0.2, once: true }} className={`text-white font-semibold sm:text-2xl text-xl font-kanit`}>
                            Ben 14 yaşımdayım. Türkiyede yaşıyorum ve Frontend kodlaması yapıyorum.
                        </motion.p>
                        <ul className='flex flex-row flex-wrap w-fit gap-2'>
                            <Socialicon
                                href='https://www.youtube.com/channel/UCEoxW2LsWEc8CH55MYR-hNg'
                            ...
                            />
                            <Socialicon
                                href='https://discord.com/users/1024632954615496764'
                            ...
                            />
                            <Socialicon
                                href='https://github.com/Kweezyx15'
                            ...
                            />
                            <Socialicon
                                href='https://instagram.com/lewixx12x'
                    ...
                    <motion.img draggable={false} initial={{ opacity: 0 }} whileInView={{ opacity: 100 }} transition={{ duration: 1, delay: 0.6, ease: [0.39, 0.21, 0.12, 0.96], }} viewport={{ amount: 0.2, once: true }} className={`relative rounded-full lg:h-72 lg:w-72 h-0 w-0 border-2 border-blue-700 xl:-translate-y-14 lg:translate-y-6 mr-8 -translate-y-0 lg:scale-100 scale-0`} alt="image" src='https://i.hizliresim.com/9yvf0l8.jpg' />
                </div>
            </section>
